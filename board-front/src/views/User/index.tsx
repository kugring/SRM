...
export default function User() {
  ...
  const UserTop = () => {
    ...
    //            function: patch prfile image response 처리 함수           //
    ...
    const patchNicknameResposne = (responseBody: PatchNicknameResponseDto | ResponseDto | null) => {
      if (!responseBody) return;
      const { code } = responseBody;
    ...
    const onNicknameEditButtomClickHandler = () => {
      if (!isNicknameChange) {
      ...
      patchNicknameRequest(requestBody, cookies.accessToken).then(patchNicknameResposne);
    }
      ...
      <div id='user-top-wrapper'>
        <div className='user-top-container'>
          ...
          <div className='user-top-info-box'>
            <div className='user-top-info-nickname-box'>
              {isMyPage ?
                <>
                  ...
                  <div className='icon-button' onClick={onNicknameEditButtomClickHandler}>
            ...
            <div className='user-top-info-email'>{'wogur8243@naver.com'}</div>
          </div>
        </div>
      </div>
    );
      ...
      <div id='user-bottom-wrapper'>
        <div className='user-bottom-container'>
          ...
          <div className='user-bottom-contents-box'>
            {count === 0 ?
              <div className='user-bottm-contents-nothing'>{'게시물이 없습니다.'}</div> :
              <div className='user-bottm-contents'>
