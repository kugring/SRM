...
export default function BoardDetail() {
  ...
  const BoardDetailBottom = () => {
    ...
    //            function: put favorite list response 처리            //
    ...
    const putFavoriteResponse = (responseBody: PutFavoriteResponseDto | ResponseDto | null) => {
      ...
      if (!boardNumber) return; // null처리 때문에 리퀘스트에 null이 들어가는것을 방지하기 위해서 return를 한다.
    ...
    const onChangeCommentClickHandler = (event: ChangeEvent<HTMLTextAreaElement>) => {
            ...
            {loginUser !== null &&
              <div className='board-detail-bottom-comment-input-box'>
                <div className='board-detail-bottom-comment-input-container'>
                  <textarea ref={commentRef} className='board-detail-bottom-comment-textarea' placeholder='댓글을 작성해주세요.' value={comment} onChange={onChangeCommentClickHandler} />
